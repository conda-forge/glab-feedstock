...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/glab-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/glab-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `glab` available on your platform:
...
```
pixi search glab --channel conda-forge
```
